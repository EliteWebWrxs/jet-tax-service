        ...
        <div class="card">
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <a href="tel:7863699058" class="text-primary-600 font-semibold hover:underline">786-369-9058</a><br>
              <a href="tel:9546670855" class="text-primary-600 font-semibold hover:underline">954-667-0855</a>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <a href="mailto:info@jettaxservicecorp.com" class="text-primary-600 font-semibold hover:underline break-all">info@jettaxservicecorp.com</a>
            </div>
          </div>
        </div>
